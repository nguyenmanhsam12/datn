                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Cập nhật mã giảm giá</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        placeholder="nhập tên mã giảm giá"name="code" value="{{ old('code',$coupon->code) }}"required>
                                        @error('code')  
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="discount_value" name="discount_value" value="{{ old('discount_value',$coupon->discount_value) }}" step="0.01" required>
                                    @error('discount_type')
                                            <div class="text-danger mt-3">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="minimum_order_value">Giá trị đơn hàng</label>
                                    <input type="number" class="form-control" id="minimum_order_value" name="minimum_order_value" value="{{ old('minimum_order_value',$coupon->minimum_order_value) }}" step="0.01" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="usage_limit" name="usage_limit" value="{{ old('usage_limit',$coupon->usage_limit) }}" step="0.01" required>
                                    @error('usage_limit')
                                            <div class="text-danger mt-3">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="end_date" name="end_date" value="{{ old('end_date',$coupon->end_date) }}" required>
                                    @error('end_date')
                                            <div class="text-danger mt-3">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status" required>
                                        ...
                                        <option value="expired" {{ old('status',$coupon->status) == 'expired' ? 'selected' : '' }}>Đã hết hạn</option>
                                    </select>   
                                    @error('status')
                                            <div class="text-danger mt-3">{{ $message }}</div>
                                    @enderror
