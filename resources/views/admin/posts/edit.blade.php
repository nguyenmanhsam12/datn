        ...
        <section class="content">
            ...
            <form action="{{ isset($post) ? route('admin.posts.update', $post->id) : route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img src="{{ asset( $post->thumbnail) }}" alt="Thumbnail" style="width: 100px; height: auto;">
                @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    @if(isset($post) && $post->secondary_image)
                        <img src="{{ asset($post->secondary_image) }}" alt="Secondary Thumbnail" style="width: 100px; height: auto;">
