    ...
    <div class="container">
        <div class="row">
            ...
            <div class="shop-content">
                ...
                <p class="countWishlist">{{ $wishlists->count() }} Items</p>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="single-product ">
                                        ...
                                        <a
                                            ...
                                            <div class="product-action clearfix spor">
                                                ...
                                                <a href="#" data-bs-toggle="tooltip"
                                                    title="Quick View" data-bs-placement="bottom">
                                                    <i class="zmdi zmdi-zoom-in"></i>
                                                </a>
                                                <a href="#" data-bs-toggle="tooltip"
                                                    title="Compare" data-bs-placement="bottom">
                                    ...
                                    <div class="product-info clearfix">
                                        <h4 data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $wishlist->product->name }}">{{ $wishlist->product->name }}</h4>
