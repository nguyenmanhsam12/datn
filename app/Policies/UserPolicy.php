...
class UserPolicy
{
    ...
    public function delete(User $user, $id)
    {
        $us = User::find($id);
        // Kiểm tra nếu người dùng có quyền xem bất kỳ bản ghi nào trong bảng User
        if ($user->checkPermissionAccess(config('permission.access.delete-user'))) {
            // Nếu người dùng có quyền, kiểm tra nếu người dùng đó đang truy cập bản ghi của chính mình
            if ($user->id === $us->id) {
                return true; // Người dùng có quyền xem bản ghi của chính mình
            }
    ...
    {
        $us = User::onlyTrashed()->find($id);
        // Kiểm tra nếu người dùng có quyền xem bất kỳ bản ghi nào trong bảng User
        if ($user->checkPermissionAccess(config('permission.access.restore-user'))) {
            // Nếu người dùng có quyền, kiểm tra nếu người dùng đó đang truy cập bản ghi của chính mình
            if ($user->id === $us->id) {
                return true; // Người dùng có quyền xem bản ghi của chính mình
            }
    ...
    public function forceDelete(User $user,$id)
    {
        $us = User::onlyTrashed()->find($id);
        // Kiểm tra nếu người dùng có quyền xem bất kỳ bản ghi nào trong bảng User
        if ($user->checkPermissionAccess(config('permission.access.fordelete-user'))) {
            // Nếu người dùng có quyền, kiểm tra nếu người dùng đó đang truy cập bản ghi của chính mình
            if ($user->id === $us->id) {
                return true; // Người dùng có quyền xem bản ghi của chính mình
            }
    ...
    {
        return $user->checkPermissionAccess(config('permission.access.listdeleted-user'));
    }
}
